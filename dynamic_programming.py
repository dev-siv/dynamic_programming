...
print(
    f"It took {datetime.now() - start} seconds to finish using recursive approach")  # took 3 minutes for 300, [14,7] input.
...
print(can_sum(target_sum, num_list))
print(
    f"It took {datetime.now() - start} seconds to finish using recursive approach")  # took 00.000014 seconds for 300, [14,7] input.
...
print(
    f"It took {datetime.now() - start} seconds to produce result for {target_sum, num_list}")  # 3.3289507 seconds for 300, [7,14]
...
print(how_sum(target_sum, num_list))
print(
    f"It took {datetime.now() - start} seconds to produce result for {target_sum, num_list}")  # 0:00:00.000032 seconds for answer.
...
start = datetime.now()
# print(can_construct('skateboard',['sk','ate','skat','skate','boar']))
print(can_construct('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeef',
                    ['e', 'ee', 'eee', 'eeee', 'eeeee']))
print(f"It took {datetime.now() - start} seconds to fulfill this operation")
